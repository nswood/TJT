...
p.add_args(
    ...
    ('--hyperbolic', p.STORE_TRUE),('--replace_mean', p.STORE_TRUE), ('--c', p.FLOAT) ,('--small_QCD', p.STORE_TRUE)
    ,('--small_feature', p.STORE_TRUE),('--hybrid', p.STORE_TRUE),
...
def load_model():
    if args.model =='DNN':
        ...
        if args.hyperbolic:
            model = models.HypeTrans(args,args.mname,_softmax,_sigmoid, args.sv,pretrain = args.pretrain)
        else:
